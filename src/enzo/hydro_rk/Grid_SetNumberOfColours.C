...
int grid::SetNumberOfColours(void)
{
  ...
  */
  ...
  if (debug1) 
    fprintf(stdout, "grid:SetNumberOfColours: NEQ_HYDRO = %"ISYM", NSpecies = %"ISYM", NColor = %"ISYM", NoMultiSpeciesButColors = %"ISYM"\n", 
  	  NEQ_HYDRO, NSpecies, NColor, NoMultiSpeciesButColors); 
